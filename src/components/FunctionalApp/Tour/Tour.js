...
function Tour({tour }) {
    ...
    return (
        <div className='tour'>
            { currentStop !== null ? 
                <TourStop stop={tour.stops[currentStop]} onNext={goToNextStop} stopNumber={currentStop + 1} totalStops={tour.stops.length} isLastStop={currentStop === tour.stops.length - 1} onPrev={goToPreviousStop} previousStopName={tour.stops[currentStop] || null} /> 
